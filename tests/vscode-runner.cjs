...
exports.run = async () => {
  try {
    ...
    await sleep(1200);
    await engine.applyCustomTheme(engine.getDefaultConfig());
    ...
    await engine.applyCustomTheme({ ...engine.getDefaultConfig(), themeMode: 'light' });
    await sleep(1600);
