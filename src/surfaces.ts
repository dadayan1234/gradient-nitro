/** VS Code 1.136.1 surface registry. Selectors are from its shipped CSS/DOM.
...
export const surfaceRegistry = {
    ...
    motion: ['.part.activitybar .action-item', '.tab', '.part.panel .composite-bar .action-item', '.monaco-toolbar .action-item', '.monaco-button', '.monaco-menu .action-item', '.quick-input-list .monaco-list-row'],
